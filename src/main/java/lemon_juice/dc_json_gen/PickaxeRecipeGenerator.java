...
public class PickaxeRecipeGenerator {
    ...
    public static String generateRecipeName(String tier1, String tier2, String tier3, int count){
        String recipeName = "src/main/resources/data/discounts_construct/recipes/pickaxes/";

        recipeName += tier1 + "_";
        recipeName += tier2 + "_";
        recipeName += tier3;

        recipeName += "_pickaxe_" + count + ".json";
        return recipeName;
    }
    ...
    public static String getOutputLine(String tier1, String tier2, String tier3){
        return "discounts_construct:" + tier1 + "_" + tier2 + "_" +  tier3 + "_pickaxe";
    }
}
